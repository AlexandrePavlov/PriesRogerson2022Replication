...
write.csv(data_sa,file="shortjobs_geography_2006.csv")
...
geo_label <- c('AL','AK','AZ','AR','CA','CO','CT','DE','FL','GA','HI','ID','IL',
...
ggsave('oneqseps_firstlast_geography_2006.pdf')
...
ggsave('hirerate_firstlast_geography_2006.pdf')