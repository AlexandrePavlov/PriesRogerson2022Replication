...
data_fs <- read.csv(paste(wd,"qwi_fs_2006.csv",sep="/"))
...
data_fs <- data_fs[!(as.numeric(data_fs$time) <= 64 | as.numeric(data_fs$time) > 112), ]
...
write.csv(data_fs,file="shortjobs_fs_2006.csv")
...
ggsave('oneqseps_firstlast_firmsize_2006.pdf')
...
ggsave('hirerate_firstlast_firmsize_2006.pdf')