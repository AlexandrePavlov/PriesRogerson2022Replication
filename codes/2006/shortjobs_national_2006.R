...
data_sa <- data_sa[!(as.numeric(data_sa$time) <= 2005*4+4 | as.numeric(data_sa$time) > 2018*4), ]
...
ggsave('hire_sep_graph_2006.pdf')
...
ggsave('hiresrate_graph_2006.pdf')
...
ggsave('oneqhazratesa_graph_2006.pdf')
...
ggsave('allthreehazrates_graph_2006.pdf')
...
ggsave('sepsratestack_graph_2006.pdf')
