...
data_sa <- data_sa[!(as.numeric(data_sa$time) <= 1998*4+4 | as.numeric(data_sa$time) > 2018*4), ]
...
ggsave('oneqhazratesa_graph.pdf')
...
ggsave('allthreehazrates_graph.pdf')
...
ggsave('sepsratestack_graph.pdf')
