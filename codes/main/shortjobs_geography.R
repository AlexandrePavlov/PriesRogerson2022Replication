...
#1998*4+4=7996 --> 36
#2018*4=8072 --> 112
#hence condition should be to drop if time<=36 | time>106
...
write.csv(data_sa,file="shortjobs_geography.csv")
...
geo_label <- c('CA','CO','CT','FL','GA','HI','ID','IL','IN','KS','LA','ME','MD',
               'MN','MO','MT','NV','NJ','NM','NC','ND','PA','RI','SC','SD','TN',
               'TX','VA','WA','WV')
...
ggsave('oneqseps_firstlast_geography.pdf')
...
ggsave('hirerate_firstlast_geography.pdf')