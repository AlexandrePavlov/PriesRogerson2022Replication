...
print('pigood1997 : ', str(round(pigood1997,4)))
print('alph1997 : ', str(round(alph1997,4)))
print('lam1997 : ', str(round(lam1997,4)))
print('\n')

[delta1,delta2,delta3,hirerate] = moments([pigood1997, alph1997, lam1997])

print('1997 values of delta1, delta2, delta3, and hirerate:')
...
print('Row 2: changes in 2017 values of delta1, delta2, delta3, and hirerate, relative to 1997 model value')
print([round(delta1-0.381,3), round(delta2-0.379,3), round(delta3-0.108,3), round(hirerate-0.210,3)])

[delta1,delta2,delta3,hirerate] = moments([pigood2017, alph1997, lam1997])

print('Row 3: changes in values of delta1, delta2, delta3, and hirerate, when only pigood changes')
print([round(delta1-0.381,3), round(delta2-0.379,3), round(delta3-0.108,3), round(hirerate-0.210,3)])

[delta1,delta2,delta3,hirerate] = moments([pigood1997, alph2017, lam1997])

print('Row 4: changes in values of delta1, delta2, delta3, and hirerate, when only alph changes')
print([round(delta1-0.381,3), round(delta2-0.379,3), round(delta3-0.108,3), round(hirerate-0.210,3)])

[delta1,delta2,delta3,hirerate] = moments([pigood1997, alph1997, lam2017])
