...
data_fs <- read.csv(paste(wd,"qwi_fs_1997.csv",sep="/"))
...
data_fa <- data_fa[!(as.numeric(data_fa$time) <= 28 | as.numeric(data_fa$time) > 112), ]
...
write.csv(data_fs,file="shortjobs_fs_1997.csv")
...
ggsave('oneqseps_firstlast_firmsize_1997.pdf')
...
ggsave('hirerate_firstlast_firmsize_1997.pdf')