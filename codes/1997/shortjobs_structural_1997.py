...
# Targeted values for probg, jfr, and meanvacdur (1997)
...
# mean vacancy duration taken from DHI-DFH data available at FRED and divided by 7
targets = np.array([0.4219, 0.422, 22.7/7])  

Params1997 = fsolve(lambda x: solvemodel(x,targets,1,0), startvals, xtol=1e-12)
fval = solvemodel(Params1997,targets,1,0)

# Reveal the calibrated 1997 values of sigeps, A, and kr
...
# Table 4: The model's 1997 moments are calculated and displayed here

# 1997 values of model moments
print('1997 values of model moments')
stats1997 = [oneqhazrate, twoqhazrate, threeplushazrate, hiresrate, jfr, meanvacdur, u]
print(stats1997)
print('\n')
...
alph = 0.1296
lam = 0.0069
targets = np.array([0.4684, 0.364, 28.1/7])  # Targeted values for probg, jfr, and meanvacdur (2017)
...
alph = 0.1438  # Set alph back to its 1997 value
lam = 0.0082  # Set lam back to its 1997 value

# Change kr
solvemodel([Params1997[0],Params1997[1],Params2017a[2]],targets,1,0)

stats2017 = [oneqhazrate, twoqhazrate, threeplushazrate, hiresrate, jfr, meanvacdur, u]
print('Changes due to change in kr:')
x = np.array(stats2017) - np.array(stats1997)
print([round(elem,4) for elem in x])
print('\n')

# Change A
solvemodel([Params1997[0],Params2017a[1],Params1997[2]],targets,1,0)
...
# Change lam
lam = 0.0069
solvemodel(Params1997,targets,1,0)
lam = 0.0082  # Restore to 1997 value
...
lam = 0.0082
solvemodel(Params1997,targets,1,0)
alph = 0.1438  # Restore to 1997 value
...
# Change sigeps
solvemodel([Params2017a[0],Params1997[1],Params1997[2]],targets,1,0)
...
# Note that there is no need here to re-do anything for the 1997 calibration. These exercises are just re-doing the 2017 calibration under the assumption that now pi0, rather than sigeps, is allowed to vary.

sigeps = 0.8088  # Fix this at the 1997 calibrated value
kh = 0.11
...
# Note: Here the first parameter is pi0, so need to set it to its 1997 value of 0.4

# Change kr
solvemodel([0.4,Params1997[1],Params2017b[2]],targets,2,0)
...
# Change A
solvemodel([0.4,Params2017b[1],Params1997[2]],targets,2,0)
...
# Change lam
lam = 0.0069
solvemodel([0.4,Params1997[1],Params1997[2]],targets,2,0)
lam = 0.0082  # Restore to 1997 value
...
# Change pi0
solvemodel([Params2017b[0],Params1997[1],Params1997[2]],targets,2,0)
...
pi0 = 0.4
kr = 0.8141  # Fix this at the 1997 calibrated value

# 2017 calibration
alph = 0.1296
lam = 0.0069
targets = np.array([0.4684, 0.364, 28.1/7])
...
# Note: Here the third parameter is kh, so need to set it to its 1997 value of 0.11 (except for the exercise where it is being changed)

# Change kh
solvemodel([Params1997[0],Params1997[1],Params2017c[2]],targets,3,0)
...
# Change A
solvemodel([Params1997[0],Params2017c[1],0.11],targets,3,0)
...
# Change lam
lam = 0.0069
solvemodel([Params1997[0],Params1997[1],0.11],targets,3,0,)
lam = 0.0082  # Restore to 1997 value
...
# Change sigeps
solvemodel([Params2017c[0],Params1997[1],0.11],targets,3,0)
...
targets = np.array([0.4219, 0.422, 22.7/7])  # Targeted values for probg, jfr, and meanvacdur (1997)

Params1997b = fsolve(lambda x: solvemodel(x,targets,1,0), startvals, xtol=1e-12)
fval = solvemodel(Params1997b,targets,1,0)
...
# Change kr
solvemodel([Params1997b[0],Params1997b[1],Params2017d[2]],targets,1,0)
...
# Change A
solvemodel([Params1997b[0],Params2017d[1],Params1997b[2]],targets,1,0)
...
# Change lam
lam = 0.0069
solvemodel(Params1997b,targets,1,0)
lam = 0.0082  # Restore to 1997 value
...
# Change sigeps
solvemodel([Params2017d[0],Params1997b[1],Params1997b[2]],targets,1,0)
...
q1wages1997 = mean_wages_first_qtr
y5wages1997 = mean_wages_fifth_year
...
print(q1wages2017/q1wages1997-1)
print('\n')

print('Percentage change in first-quarter/fifth-year ratio')
print((q1wages2017/y5wages2017)/(q1wages1997/y5wages1997)-1)
print('\n')
...
# 2017 value for sigeps, 1997 for all others
alph = 0.1438
lam = 0.0082
solvemodel([Params2017a[0],Params1997[1],Params1997[2]],targets,1,0)
calculate_mean_wages()
...
print('First-quarter wages in 1997')
print(q1wages1997)
print('\n')
...
print('Percentage change in first-quarter mean wages')
print(round(q1wages2017,3)/round(q1wages1997,3)-1)
print('\n')

print('Fifth-year wages in 1997')
print(round(y5wages1997,3))
print('\n')
...
print(round(y5wages2017,3)/round(y5wages1997,3)-1)
print('\n')
